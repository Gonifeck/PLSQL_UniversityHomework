...
BEGIN
    SELECT count(*) 
    INTO CODIGO_DIR_DESPACHO
    FROM DIRECCIONES_DESPACHO;
END;
...
BEGIN
    SELECT VALIDACION_COMPRA.ESTADO_COMPRA
    INTO ESTADO_COMPRA
...
BEGIN
    ...
    IF STOCK_PRODUCTO >= CANTIDAD THEN
        UPDATE PRODUCTO
        SET PRODUCTO.STOCK = (STOCK_PRODUCTO-CANTIDAD)
        WHERE PRODUCTO.CODIGO_PRODUCTO = CODIGO_PRODUCTO;
    ELSE
